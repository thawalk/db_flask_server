...
metadata_collection = pymongo.collection.Collection(db, 'test_collection')
print(metadata_collection.find({"asin":"1603420304"})
# impt = dumps(list(collection.find({"asin":"1603420304"})))
# time.sleep(30)
print(impt)
