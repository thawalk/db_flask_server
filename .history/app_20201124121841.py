...
def add_review():
    try:
        ...
        mySQL_insert_query = f"""INSERT INTO kinde_reviews (asin, helpful, overall, reviewText, reviewTime, reviewerID, reviewerName, summary, unixReviewTime)
            VALUES ({asin},{helpful},{overall},{reviewText},{reviewTime},{reviewerID},{reviewerName},{summary},{unixReviewTime});"""

        mySQL_insert_query2 = """INSERT INTO reviews.kindle_reviews (asin, helpful, overall, reviewText, reviewTime, reviewerID, reviewerName, summary, unixReviewTime)
VALUES ("A1234567","[0,0]",5,"Actually not bad la","27 07 2020","AKMAL123","Akmal Hakim","wah this book damn bad.","1606188658");"""    
