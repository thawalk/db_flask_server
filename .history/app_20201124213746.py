...
metadata_col = pymongo.collection.Collection(metadb, 'test_collection')

userlogging_col = pymongo.collection.Collection()
...
def user_logging(userid,timestamp,req,res):
    return metadata_col.insert({"id":userid,"timestamp":timestamp,"request":req,"response":res})
